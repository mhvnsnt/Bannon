...
const MODULES = [
  ...
  'BANNON_INTERFERENCE', 'BANNON_SEGMENT', 'BANNON_COMBAT_MOCAP', 'BANNON_MOVESET_SLOTS', 'BANNON_BASES', 'BANNON_COMBO', 'BANNON_PROCGEN', 'BANNON_AUTHORED', 'BANNON_VARIANTS', 'BANNON_LEGAL', 'BANNON_LIFE', 'BANNON_LIFE_UI', 'BANNON_MOVE_VARIANTS', 'BANNON_PINS', 'BANNON_MOVESET_STUDIO', 'BANNON_REACH', 'BANNON_GRID', 'BANNON_ROAMFREE', 'BANNON_PERF', 'BANNON_ROSTER_MOVESETS', 'BANNON_PAYBACKS', 'BANNON_CLIP_ROTATE', 'BANNON_SHOWTIME', 'BANNON_SEASON', 'BANNON_TAG', 'BANNON_ROSTER', 'BANNON_SAVES', 'BANNON_STIP', 'BANNON_OWNER_MOVES', 'BANNON_WARM', 'BANNON_GFX', 'BANNON_PREWARM', 'BANNON_BRIDGE', 'BANNON_PANELS', 'BANNON_STYLE', 'BANNON_WALKOUT', 'BANNON_MATCHRULES', 'BANNON_BONELOCK'
];
