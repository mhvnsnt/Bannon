...
const MODULES = [
  ...
  'BANNON_INTERFERENCE', 'BANNON_SEGMENT', 'BANNON_COMBAT_MOCAP', 'BANNON_MOVESET_SLOTS', 'BANNON_BASES', 'BANNON_COMBO', 'BANNON_PROCGEN', 'BANNON_AUTHORED', 'BANNON_VARIANTS', 'BANNON_LEGAL', 'BANNON_LIFE', 'BANNON_LIFE_UI', 'BANNON_MOVE_VARIANTS', 'BANNON_PINS', 'BANNON_MOVESET_STUDIO', 'BANNON_REACH', 'BANNON_GRID'
];
