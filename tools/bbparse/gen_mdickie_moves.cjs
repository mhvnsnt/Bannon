...
const MAP = {
  ...
  'reverse ddt':            ['Backspin Spike',       {pos:'REVERSE_DDT',mode:'front',deliver:'spike',from:'STANDING_FRONT',style:['technical','showman']}],
  ...
  'x-factor':               ['The X-Verdict',        {pos:'DDT',mode:'front',deliver:'spike',from:'STANDING_FRONT',style:['highFlyer','striker']}],
  'stunner':                ['The Reckoning Cutter', {pos:'REVERSE_DDT',mode:'front',deliver:'spike',from:'STANDING_FRONT',style:['striker','showman']}],
  'rock bottom':            ['The Bottom Line',      {pos:'SIDE_SLAM',mode:'front',deliver:'slam',from:'STANDING_FRONT',style:['powerhouse']}],
  'bulldog':                ['Running Bulldog',      {pos:'REVERSE_DDT',mode:'front',deliver:'spike',from:'ROPE_REBOUND',style:['brawler','showman']}],
  'neckbreaker':            ['Neck Verdict',         {pos:'REVERSE_DDT',mode:'front',deliver:'spike',from:'STANDING_FRONT',style:['technical']}],
  'skull crushing finale':  ['Cranial Finale',       {pos:'SIDE_SLAM',mode:'front',deliver:'spike',from:'STANDING_FRONT',style:['technical']}],
  // --- TOSS / TAKEDOWN / THROW ---
  ...
  'snapmare':               ['Snap Takedown',        {pos:'ATOMIC_DROP',mode:'front',deliver:'toss',from:'STANDING_FRONT',style:['technical']}],
  'drop toe hold':          ['Toe-Hold Takedown',    {pos:'STANDARD',mode:'front',deliver:'toss',from:'STANDING_FRONT',style:['technical','mma']}],
  'russian legsweep':       ['Sickle Sweep',         {pos:'REVERSE_DDT',mode:'rear',deliver:'spike',from:'STANDING_REAR',style:['technical']}],
