...
public class BannonCore : ModuleRules
{
	public BannonCore(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] {
			...
			"Json", "JsonUtilities", "BannonEngine"
		});
		...
		// External Open Source Integration: JoltPhysics
		string JoltInclude = Path.GetFullPath(Path.Combine(ModuleDirectory, "..", "..", "ThirdParty", "JoltPhysics"));
		PublicIncludePaths.Add(JoltInclude);
